...
public class Nmea {
    ...
    public class GPSPosition {
        ...
        public NemaLocation toLocation() {
            NemaLocation loc = new NemaLocation();
            loc.setAccuracy(this.quality);
            loc.setAltitude(this.altitude);
            loc.setBearing(this.dir);
            loc.setLatitude(this.lat);
            loc.setLongitude(this.lon);
            loc.setSpeed(this.velocity);
            loc.setTime((long)this.time);
            return loc;
        }
    }
    ...
    private AGFBluetoothDevice device = null;
    public Nmea(AGFBluetoothDevice device) {
        this.device = device;
    ...
    public GPSPosition parse(String line) {
        ...
        if(line.startsWith("$")) {
            ...
            position.updatefix();
            device.locationChangedEvent(position.toLocation());
        }
